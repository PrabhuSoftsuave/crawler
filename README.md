...
``` sh
storm jar target/crawler-1.0-SNAPSHOT.jar crawler.CrawlTopology -conf crawler-conf.yaml -local
```
...
``` sh
storm jar target/crawler-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux --local crawler.flux --sleep 86400000
```
